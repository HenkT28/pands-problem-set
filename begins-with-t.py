...
# https://stackoverflow.com/a/9847269 - Return the day of the week as an integer, where Monday is 0 and Sunday is 6.
...
# Using single "or" statement to include both days.
